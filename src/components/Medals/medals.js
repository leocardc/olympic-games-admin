...
import Sport_Event from '../SportEvent/sport_event';
      ...
      <br /><br />
        <table className="table ">
          ...
          {this.state.data.map(medal=>{
              ...
              <td>
                    <button className="btn btn-primary" onClick={()=>{this.seleccionarPais(medal); this.modalInsertar()}}><FontAwesomeIcon icon={faEdit}/></button>
                    {"   "}
                    <button className="btn btn-danger" onClick={()=>{this.seleccionarPais(medal); this.setState({modalEliminar: true})}}><FontAwesomeIcon icon={faTrashAlt}/></button>
                    </td>
              </tr>
              )
            })}
        ...
        <Modal isOpen={this.state.modalInsertar}>
                    ...
                    <ModalBody>
                      <div className="form-group">
                        ...
                        <input className="form-control" type="text" name="id" id="id"  onChange={this.handleChange} value={form?form.id : this.state.data.length+2}/>
                        <br />             
              ...
              <Modal isOpen={this.state.modalEliminar}>
                <ModalBody>
                   Estás seguro que deseas eliminar la premiación
                </ModalBody>
                <ModalFooter>
